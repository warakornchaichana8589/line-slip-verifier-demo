...
exports.createProductCatalogFlexMessage = createProductCatalogFlexMessage;
 ...
 */
function createProductCatalogFlexMessage() {
    return {
        type: 'flex',
 ...
 */
function createUnderpaidFlexMessage(data) {
    return {
        type: 'flex',
